...
map('n', '<leader>gA', '<cmd>Telescope git_stash<cr>', { noremap = true })
...
local function setup_servers()
  ...
  for _, server in pairs(servers) do
    if server_specific_config[server]
      then
        config = server_specific_config[server]
